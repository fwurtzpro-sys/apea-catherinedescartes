    ...
    <section className="relative overflow-hidden bg-white pb-8 pt-10 sm:pb-10 sm:pt-14 lg:pt-16">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:gap-10 lg:px-8">
        ...
        <div className="relative mx-auto w-full max-w-md lg:max-w-none">
          ...
          <Reveal delay={100} direction="none" scale immediate>
          ...
          <Reveal
            delay={320}
            immediate
            className="absolute -top-2 right-2 max-w-[190px] sm:right-4 sm:top-2"
          >
            <div className="rounded-3xl rounded-bl-md bg-navy-900 px-5 py-3.5 text-white shadow-lg shadow-navy-900/30">

...
const hasConfirmedContact = SITE.emailConfirmed || SITE.addressConfirmed;
    ...
    <>
      ...
      <Container className="py-16 sm:py-20">
        {hasConfirmedContact ? (
          ...
          <EmptyState
            icon={Sparkles}
            title="Nos coordonnées de contact arrivent bientôt"
            description="Cette page affichera très prochainement l'e-mail et les moyens de contact officiels de l'association. En attendant, suivez nos actualités et événements sur ce site."
          />
        )}
      </Container>
    </>

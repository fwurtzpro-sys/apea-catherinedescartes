    ...
    <>
      ...
      <Container className="py-16 sm:py-20">
        <Reveal
          strong
          scale
          className="mx-auto flex max-w-xl flex-col items-center gap-4 rounded-[2.5rem] border-2 border-dashed border-orange-200 bg-cream-100/60 p-8 text-center sm:p-12"
        >
